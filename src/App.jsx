...
今日資料：${raw.slice(0,3000)}`,800))
  ...
  const fetchHomeNews=async(forceRefresh=false)=>{
    ...
    if(!forceRefresh){
      try{
        const cached=await loadUserData("bf17b901-57e4-423f-9662-8c272ce866b3",CACHE_KEY);
...
投資焦點新聞：${rawInvest.slice(0,1500)}`,3000);
      ...
      if(data.news?.length>0){
        ...
        saveUserData("bf17b901-57e4-423f-9662-8c272ce866b3",CACHE_KEY,{news:newsWithImages,cachedAt:new Date().toISOString()}).catch(console.error);
      }
...
今日資料：${raw.slice(0,3000)}`,800))
  ...
  const LOCAL_ACCOUNTS=[
    {username:"Kate",password:"kate2026",is_kate:true,display_name:"凱特",risk_level:"穩健",id:"bf17b901-57e4-423f-9662-8c272ce866b3"},
    {username:"kate",password:"kate2026",is_kate:true,display_name:"凱特",risk_level:"穩健",id:"bf17b901-57e4-423f-9662-8c272ce866b3"},
  ];
  const handleLogin=async()=>{
    ...
    if(localUser){
      ...
      try{
        ...
        const prodData=await loadUserData("bf17b901-57e4-423f-9662-8c272ce866b3","kate_products");
                        ...
                        <div style={{display:"flex",alignItems:"flex-start",gap:10}}>
                          ...
                          <div style={{display:"flex",gap:6,flexShrink:0}}>
                            ...
                            <button onClick={()=>{
                              ...
                              saveUserData("bf17b901-57e4-423f-9662-8c272ce866b3","kate_products",next).catch(console.error);
                              showToast("✓ 產品已刪除");
